...
public class BrandsListAdapter extends Adapter<ViewHolder> implements Filterable {
    ...
    private final List<MobileBrandFragment.BrandItem> mData, mFilteredData;
    ...
    public BrandsListAdapter(final Context _context) {
        this(_context, new ArrayList<MobileBrandFragment.BrandItem>());
    }

    public BrandsListAdapter(final Context _context, final List<MobileBrandFragment.BrandItem> _data) {
    ...
    private void setFilteredData(final List<MobileBrandFragment.BrandItem> _filteredData) {
        mFilteredData.clear();
    ...
    private class BrandFilter extends Filter {
        ...
        private final List<MobileBrandFragment.BrandItem> listData;

        public BrandFilter(List<MobileBrandFragment.BrandItem> _listData) {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (TextUtils.isEmpty(constraint)) {
                ...
                List<MobileBrandFragment.BrandItem> filteredList = getFilteredList(constraint);
        ...
        private List<MobileBrandFragment.BrandItem> getFilteredList(CharSequence _constraint) {
            List<MobileBrandFragment.BrandItem> serviceList = new ArrayList<>();
            for (int i = 0; i < listData.size(); i++) {
                MobileBrandFragment.BrandItem name = listData.get(i);
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            List<MobileBrandFragment.BrandItem> filteredData = (List<MobileBrandFragment.BrandItem>) results.values;
    ...
    protected final class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        protected final void setData(int position, @NonNull MobileBrandFragment.BrandItem data) {
...
//            hvBrandImage.setHexagonSrcDrawable(data.mBrandImageRes);
    ...
    public interface OnBrandSelectListener {
        void onBrandSelect(final MobileBrandFragment.BrandItem _item);
    }
}