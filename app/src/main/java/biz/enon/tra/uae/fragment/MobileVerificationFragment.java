...
import biz.enon.tra.uae.activity.ScannerActivity;
...
import biz.enon.tra.uae.rest.robo_requests.SearchByImeiRequest;

/**
 * Created by mobimaks on 13.08.2015.
 */
public class MobileVerificationFragment extends BaseServiceFragment
        implements OnClickListener, OnOpenPermissionExplanationDialogListener, AlertDialogFragment.OnOkListener, PermissionManager.OnPermissionRequestSuccessListener {
